...
#include "FMDemoRTLSDR_DLL_terminate.h"
#include "rt_nonfinite.h"

/* Function Declarations */
static void argInit_1x35830_real_T(double result[35830]);
static double argInit_real_T(void);
static void main_FMDemoRTLSDR_DLL(void);
...
static void main_FMDemoRTLSDR_DLL(void)
{
  static double ISamples_tmp[35830];
  static double Baseband[35829];

  /* Initialize function 'FMDemoRTLSDR_DLL' input arguments. */
  /* Initialize function input argument 'ISamples'. */
  argInit_1x35830_real_T(ISamples_tmp);

  /* Initialize function input argument 'QSamples'. */
  /* Call the entry-point 'FMDemoRTLSDR_DLL'. */
  FMDemoRTLSDR_DLL(ISamples_tmp, ISamples_tmp, Baseband);
}
