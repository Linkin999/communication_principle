/*
 * _coder_Ex1_add_info.c
 *
 * Code generation for function '_coder_Ex1_add_info'
 *
 */
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("Ex1_add"));
...
/* End of code generation (_coder_Ex1_add_info.c) */
