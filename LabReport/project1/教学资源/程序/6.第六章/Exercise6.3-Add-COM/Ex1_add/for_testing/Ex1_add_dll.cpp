...
{
  {
    ...
    Class1::GetClassObject, "Class1", "Ex1_add.Class1", "Ex1_add.Class1.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
{
  initialize_path();
  return g_pModule->InitMain(objectmap, &LIBID_Ex1_add, 1, 0, hInstance, dwReason, pv);
}
