...
-Ex1_add_1_0.dll (output from mcc)
-MCRInstaller.exe
...
NOTE: Verify Ex1_add_1_0.dll is registered on the target machine. If you have trouble 
      registering this DLL, see Troubleshooting in the MATLAB .NET Assembly documentation 
      in the MathWorks Documentation Center.
