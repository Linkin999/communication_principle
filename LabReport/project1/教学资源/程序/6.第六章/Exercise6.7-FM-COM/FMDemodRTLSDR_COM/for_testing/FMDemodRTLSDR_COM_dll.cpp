...
#include "FMDemodRTLSDR_COM_idl_i.c"
...
{
  {
    ...
    Class1::GetClassObject, "Class1", "FMDemodRTLSDR_COM.Class1", 
    "FMDemodRTLSDR_COM.Class1.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
static void initialize_path()
{
    ...
    build_mclmcrrt_name("9","0","1",mclmcrrt_name);
...
{
  initialize_path();
  return g_pModule->InitMain(objectmap, &LIBID_FMDemodRTLSDR_COM, 1, 0, hInstance, 
                             dwReason, pv);
}
